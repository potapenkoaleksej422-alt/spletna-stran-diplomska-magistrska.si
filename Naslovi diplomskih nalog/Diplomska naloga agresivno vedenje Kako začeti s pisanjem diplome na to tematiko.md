---
Naslov objave: "Diplomska naloga agresivno vedenje: Kako začeti s pisanjem diplome na to tematiko?"
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-10T15:54:51+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga agresivno vedenje: Kako začeti s pisanjem diplome na to tematiko?

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-agresivno-vedenje/](https://diplomska-magistrska.si/diplomska-naloga-agresivno-vedenje/)
...
Soočili ste se torej z izzivom, da morate začeti s pisanjem diplomskega dela o AGRESIVNEM VEDENJU.

Obstaja velika verjetnost, da vam bo ta prispevek tako koristen, da ga boste dodali med svoje zaznamke.

Kakorkoli že, moj cilj je, da iz te vsebine potegnete maksimalno korist in drastično skrajšate čas izdelave diplomske naloge o AGRESIVNEM VEDENJU.
...
- kako iskati že uspešne diplomske naloge, ki so prav tako raziskovale področje o "AGRESIVNEM VEDENJU"
- kako in kje najti diplomske naloge, ki se dotikajo podobne tematike
- kako skozi postopek iskanja literature na temo *"agresivno vedenje"* poiskati knjige, priročnike, znanstvene članke in tuje vire

Ker podobno kot mnogi najbrž niste prepričani, kako se lotiti pisanja svojega dela, vam lahko svetujem, da je najprimerneje pričeti z raziskovanjem spletnih virov in pregledom že uspešnih nalog na temo agresivno vedenje.
...
**agresivno vedenje** je tema, s katero ste verjetno že seznanjeni in je morda del vašega vsakdana, naj bo to preko študija, osebnih zanimanj, prostočasnih dejavnosti ali osebnih izkušenj.
Če je tema ***"agresivno vedenje"*** le začetna ideja in še niste določili natančnega naslova za svoje diplomsko delo, imam za vas dobro novico. Ob koncu te objave boste našli nasvete, ki vam bodo pomagali "brainstormati" ideje vašega (bodočega) zaključnega dela.

## Kako se lotiti pisanja dispozicije o "AGRESIVNEM VEDENJU"?

Vsaka diplomska naloga o "AGRESIVNEM VEDENJU" se začne z dispozicijo, ki služi kot natančno določen načrt vašega dela. Ta dokument mora obvezno vsebovati jasno definirane cilje in namen, izbrano raziskovalno metodologijo, predvideno kazalo vsebine, seznam literature za preučevanje ter jasno opredeljen raziskovalni problem z njegovimi omejitvami.
...
## Kateri tip raziskovalne metode izbrati za nalogo o AGRESIVNEM VEDENJU?

Pri raziskovanju teme o "AGRESIVNEM VEDENJU" se boste morali odločiti za ustrezen raziskovalni pristop. V slovenskem visokošolskem prostoru se naloge tipično delijo na teh pet osnovnih metodoloških vrst - seveda si vi izberite tistega, ki je za vaš naslov oz. tematiko najprimernejši in vam omogoča najhitrejšo pot do zaključka.
...
Ko prijavljate temo o "AGRESIVNEM VEDENJU", bodite izjemno previdni pri izbiri mentorja. Najbolj varna izbira je profesor, ki velja za "prizanesljivega" oziroma morda celo pasivnega ocenjevalca. Če ima vaš izbrani mentor zraven še svoje podjetje ali predava drugje na kakšnem drugem faksu, ste zadeli "terno" – zaradi pomanjkanja časa se namreč takšni mentorji redko spuščajo v malenkosti in ne komplicirajo. Še en pomemben nasvet: strogo se izogibajte dodajanju somentorjev. Več vključenih ljudi pomeni več različnih "muh" in zahtev, kar lahko izdelavo vaše diplomske naloge zavleče za več mesecev.

## Brskanje po tujih diplomskih nalogah

[Pregled sorodnih diplomskih del, ki so bila kadarkoli objavljena v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:agresivno+vedenje;1:20:211;)

[Tukaj boste našli primere hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=agresivno%20ponašanje&ct%5B%5D=thesis&yr_from=&yr_to=)

[Tukaj boste našli primere srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=agresivno+ponašanje&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28aggressive%20AND%20behavior%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjižnično gradivo (COBISS in šolska knjižnica)](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=agresivno+vedenje&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=agresivno+vedenje&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=aggressive+behavior&hl=en&as_sdt=0,5)

[**Anna's Archive** (obsežna zbirka skoraj vse akademske literature)](https://annas-archive.gl/search?q=aggressive+behavior)

[**Anna's Archive (alternativna povezava 1)** (povezava .pk)](https://annas-archive.pk/search?q=aggressive+behavior)

[**Anna's Archive (alternativna povezava 2)** (povezava .gd)](https://annas-archive.gd/search?q=aggressive+behavior)
...
site:oatd.org aggressive behavior

site:oatd.org aggressive behavior AND violent behavior
...
Pri iskanju literature za diplomsko o AGRESIVNEM VEDENJU lahko uporabite različne vire. Spodaj imate pripravljen seznam baz in pa direktnih povezav do le-teh, ki bodo samodejno sprožile iskanje po tovrstnih zbirkah na temo o "agresivno vedenje".

### Znanstvene in akademske članke (Google Učenjak, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleški članki od 2021 naprej s prostim dostopom do PDF)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=aggressive+behavior&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (globalna platforma za raziskovalce)](https://www.researchgate.net/search/publication?q=aggressive+behavior)

[Iskanje na **CORE** (zbirka z več kot 300 milijoni odprtodostopnih člankov in člankov)](https://core.ac.uk/search?q=aggressive+behavior)

[Iskanje na **BASE** (akademski iskalnik z več kot 400 milijoni dokumentov)](https://www.base-search.net/Search/Results?lookfor=aggressive+behavior&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo agresivnega vedenja?

Pri raziskovanju agresivnega vedenja uporabi kombinacijo psiholoških in socioloških pristopov. Izvedi strukturirane intervjuje s strokovnjaki s področja vedenjskih motenj. Uporabi standardizirane vprašalnike za merjenje ravni agresivnosti. Dodaj opazovanje vedenjskih vzorcev v kontroliranem okolju.

### Ali je za raziskavo agresivnega vedenja primernejša kvalitativna ali kvantitativna metodologija?

Pri proučevanju agresivnega vedenja je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo pogostosti in intenzivnosti agresivnih dejanj. Kvalitativni del naj obsega poglobljene intervjuje z žrtvami, povzročitelji in strokovnjaki ter analizo individualnih primerov.

### Kako opredeliti omejitve raziskave pri proučevanju agresivnega vedenja?

V dispoziciji jasno zapiši etične omejitve raziskovanja. Navedi omejitve pri dostopu do občutljivih osebnih podatkov. Opredeli starostne in demografske omejitve vzorca. Zapiši časovni okvir raziskave in morebitne institucionalne omejitve pri zbiranju podatkov.

### Kako pravilno zastaviti hipoteze o agresivnem vedenju?

Hipoteze morajo biti specifične in merljive. Primer: "Programi čustvene inteligence bodo zmanjšali agresivno vedenje med mladostniki za 40%". Ali: "Zgodnja psihoterapevtska intervencija bo znižala ponavljanje nasilnih dejanj za 35%". Možna je tudi: "Izboljšanje komunikacijskih veščin bo zmanjšalo konflikte za 25%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tej temi ključnega pomena. Vključi vsaj 8 do 10 mednarodnih raziskav iz zadnjih petih let. Dodaj primerjave iz različnih kulturnih okolij. Posebej pomembne so raziskave o vzrokih in preprečevanju agresivnega vedenja.

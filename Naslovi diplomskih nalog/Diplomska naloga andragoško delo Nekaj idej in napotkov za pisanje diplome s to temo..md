---
Naslov objave: "Diplomska naloga andragoško delo: Nekaj idej in napotkov za pisanje diplome s to temo."
...
# Diplomska naloga andragoško delo: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-andragosko-delo/](https://diplomska-magistrska.si/diplomska-naloga-andragosko-delo/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o ANDRAGOŠKEM DELU.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o ANDRAGOŠKEM DELU na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o ANDRAGOŠKEM DELU
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o ANDRAGOŠKEM DELU poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (andragoško delo) že bile uspešne.
...
**andragoško delo** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"andragoško delo"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o ANDRAGOŠKEM DELU

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o ANDRAGOŠKEM DELU. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o ANDRAGOŠKEM DELU boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o ANDRAGOŠKEM DELU. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:andragoško+delo;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=andragoški%20rad&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=andragoški+rad&submit=&locale-attribute=en)
...
[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=andragoško+delo&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=andragoško+delo&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=andragogical+work&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=andragogical+work)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=andragogical+work)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=andragogical+work)
...
site:oatd.org andragogical work AND andragogical counseling
...
Za kakovostno napisano diplomsko nalogo o ANDRAGOŠKEM DELU imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "andragoško delo".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=andragogical+work&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=andragogical+work)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=andragogical+work)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=andragogical+work&type=all)
...
Pri raziskovanju andragoškega dela lahko uporabiš kombinacijo pristopov. Izvedi strukturirane intervjuje z andragoškimi delavci in mentorji. Uporabi analizo obstoječih izobraževalnih programov in dokumentacije. Dodaj opazovanje učnih procesov in evalvacijo učnih izidov.

### Ali je za raziskavo andragoškega dela primernejša kvalitativna ali kvantitativna metodologija?

Za andragoško delo je najprimernejša kombinirana metodologija. V kvantitativnem delu analiziraj statistične podatke o udeležencih izobraževanj, njihovi uspešnosti in napredku. V kvalitativnem delu izvedi poglobljene intervjuje z andragogi in analizo učnih strategij.

### Kako opredeliti omejitve raziskave pri proučevanju andragoškega dela?

V dispoziciji zapiši omejitve pri dostopu do izobraževalnih institucij. Navedi omejitve vzorca udeležencev izobraževanj. Opredeli časovno obdobje raziskave. Dodaj omejitve pri pridobivanju podatkov o učnih procesih in osebnih izkušnjah udeležencev.

### Kako pravilno zastaviti hipoteze o andragoškem delu?

Pri hipotezah bodi konkreten in merljiv. Primer: "Personalizirani učni pristopi bodo povečali motivacijo odraslih udeležencev za 40%". Ali: "Digitalne učne platforme bodo izboljšale dostopnost izobraževanj za 35%". Možna je tudi: "Interdisciplinarni pristop bo povečal učinkovitost izobraževanja za 30%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri andragoškem delu zelo priporočljiva. Vključi vsaj 8 do 12 mednarodnih raziskav o izobraževanju odraslih. Dodaj primere dobrih praks iz različnih evropskih držav. Posebej pomembne so raziskave o inovativnih učnih metodah.

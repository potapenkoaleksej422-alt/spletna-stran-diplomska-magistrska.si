---
Naslov objave: "Magistrska naloga računovodstvo: Nasveti za uspešno izdelavo magistrske s takšnim naslovom."
...
# Magistrska naloga računovodstvo: Nasveti za uspešno izdelavo magistrske s takšnim naslovom.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/magistrska-naloga-racunovodstvo/](https://diplomska-magistrska.si/magistrska-naloga-racunovodstvo/)
...
Znašli ste se torej v situaciji, ko morate pričeti z izdelavo magistrske naloge o "RAČUNOVODSTVU".

Možno je, da vam bo ta članek služil kot odličen pripomoček in si ga boste celo shranili med priljubljene strani.

Vsekakor pa upam, da boste iz prebranega odnesli čim več ter tako čas pisanja magistrske naloge o RAČUNOVODSTVU zmanjšali na popoln minimum.
...
- kako poiskati in prebrskati že zaključena magistrska dela študentov, ki so se morda že uspešno spopadli z izzivom tematike o "RAČUNOVODSTVU"
- vas opremi z znanjem za učinkovito iskanje magistrskih nalog na sorodnem področju
- vam priporoči, kje in kako najti ustrezno literaturo o temi "računovodstvo", vključno z akademskimi in strokovnimi viri (knjigami, znanstvenimi članki, raziskovalnimi članki, tujimi viri, ipd.)

Ker enako kot drugi verjetno nimate jasne predstave o tem, kje začeti s sestavljanjem svojega zaključnega dela, vam lahko predlagam, da je najbolj koristno začeti z iskanjem in preučevanjem že obstoječih uspešnih nalog s tematiko "računovodstvo".
...
Ne glede na to, kako kompleksno se sliši tema "računovodstvo", bo vaša naloga na koncu vedno spadala v eno od petih klasičnih kategorij metodologij, ki se uporabljajo na slovenskih fakultetah. Seveda, za to temo ni primerna vsaka od teh petih, zato si izberite tisto, ki bo relevantna in pa predvsem - najlažja vam, da ne boste magistrske naloge pisali celo večnost.
...
Vaša pot do magisterija o tematiki RAČUNOVODSTVU bo bistveno lažja, če boste izbrali "pragmatičnega", oziroma še bolje pasivnega mentorja. Idealni so tisti profesorji, ki zraven predavanj opravljajo še kakšno "obšolsko" dejavnost (imajo s.p. ali d.o.o.) ali pa morda predavajo še na kakšni drugi fakulteti, saj zaradi tega ne iščejo "dlake v jajcu" in so veliko bolj življenjski pri popravkih. Vsekakor pa se kolikor je to mogoče, izognite somentorjem! Prisotnost somentorja namreč vedno prinese dodatna usklajevanja, nasprotujoča si mnenja z glavnim mentorjem in podaljša vaš čas pisanja.

## Iskanje sorodnih magistrskih nalog

[Zbirka vseh relevantnih magistrskih nalog s sorodnimi temami, ki so bila kadarkoli objavljena v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:računovodstvo;1:20:209;)

[Primeri hrvaških magistrskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=računovodstvo&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih magistrskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=racunovodstvo&submit=&locale-attribute=en)

[Primeri magisterijev iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28accounting%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Literatura iz knjižnic (COBISS, šolska knjižnica)](https://plus.cobiss.net/cobiss/si/sl/bib/search?q=računovodstvo&db=cobib&mat=allmaterials&cof=0_105b-v&cof=0_105b-r&cof=0_105f-z&cof=0_105b-j&cof=0_105b-v1&cof=0_105b-r4&tyf=0_knj&tyf=0_cla&tyf=0_evir&tyf=0_ser&max=100)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=računovodstvo&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=accounting&hl=en&as_sdt=0,5)

[**Anna's Archive** (globalna knjižnica skoraj vseh člankov in knjig)](https://annas-archive.gl/search?q=accounting)

[**Anna's Archive (alternativni link 1)** (.pk domena)](https://annas-archive.pk/search?q=accounting)

[**Anna's Archive (alternativni link 2)** (.gd domena)](https://annas-archive.gd/search?q=accounting)
...
site:oatd.org accounting

site:oatd.org accounting AND financial operations
...
Za raziskovanje teme o RAČUNOVODSTVU, lahko uporabite številne (brezplačne) in slovenskim študentom dostopne baze. Spodaj vas čaka seznam le-teh in pa njihove direktne povezave, ki že izpolnjujejo kriterij iskanja o temi "računovodstvo".

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021+ s PDF dostopom)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=accounting&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (mreža raziskovalcev z brezplačnimi članki)](https://www.researchgate.net/search/publication?q=accounting)

[Iskanje na **CORE** (nad 300 milijonov odprtodostopnih akademskih del)](https://core.ac.uk/search?q=accounting)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – ena največjih akademskih iskalnikov)](https://www.base-search.net/Search/Results?lookfor=accounting&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo računovodskih procesov?

Pri analizi računovodskih procesov lahko uporabiš kombinacijo pristopov. Izvedi strukturirane intervjuje z računovodji in finančnimi direktorji. Analiziraj računovodsko dokumentacijo in finančne izkaze. Dodaj tudi opazovanje delovnih procesov in pregled računovodskih standardov ter praks.

### Ali je za raziskavo računovodstva primernejša kvalitativna ali kvantitativna metodologija?

Za raziskavo računovodskih procesov je najprimernejša kombinirana metodologija. V kvantitativnem delu analiziraj finančne kazalnike, bilance in statistične podatke. V kvalitativnem delu izvedi poglobljene intervjuje z računovodskimi strokovnjaki in analizo implementacije računovodskih standardov.

### Kako opredeliti omejitve raziskave pri proučevanju računovodskih procesov?

V dispoziciji zapiši omejitve pri dostopu do finančnih dokumentov. Navedi omejitve vzorca podjetij ali organizacij. Opredeli časovno obdobje analize. Dodaj tudi omejitve pri pridobivanju internih podatkov zaradi varstva poslovnih skrivnosti.

### Kako pravilno zastaviti hipoteze o računovodskih procesih?

Pri hipotezah bodi konkreten in merljiv. Primer: "Digitalizacija računovodskih procesov bo zmanjšala administracijo za 40%". Ali: "Implementacija mednarodnih računovodskih standardov bo povečala transparentnost za 35%". Možna je tudi: "Avtomatizirani sistemi bodo skrajšali čas priprave poročil za 25%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tej temi zelo priporočljiva. Vključi vsaj 8 do 12 mednarodnih raziskav s področja računovodstva. Dodaj primerjave iz različnih evropskih držav. Posebej pomembne so raziskave o digitalnih transformacijah v računovodstvu.

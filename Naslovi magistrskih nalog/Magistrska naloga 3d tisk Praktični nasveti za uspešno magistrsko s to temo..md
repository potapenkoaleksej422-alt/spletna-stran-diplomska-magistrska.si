---
Naslov objave: "Magistrska naloga 3d tisk: Praktični nasveti za uspešno magistrsko s to temo."
...
# Magistrska naloga 3d tisk: Praktični nasveti za uspešno magistrsko s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/magistrska-naloga-3d-tisk/](https://diplomska-magistrska.si/magistrska-naloga-3d-tisk/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja magistrske naloge o 3D TISKU.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega magistrskega dela o 3D TISKU na absolutni minimum.
...
- kako poiskati uspešne magistrske naloge drugih študentov, ki so prav tako imeli temo o 3D TISKU
- kje iskati magistrske naloge s podobno temo (in kako)
- vam pokaže kje in kako na temo 3d tisk poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (3d tisk) že bile uspešne.
...
**3d tisk** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"3d tisk"*** zgolj iztočnica ali misel in točnega naslova za magistrsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče magistrske naloge.

## Priprava dispozicije za magistrsko nalogo o 3D TISKU

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem magistrske naloge o 3D TISKU. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o 3D TISKU boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča magistriranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše magistrske naloge o 3D TISKU. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj pragmatični, življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih magistrskih nalog

[Primeri vseh kadarkoli objavljenih magistrskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:3d+tisk;1:20:209;)

[Primeri hrvaških magistrskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=3D%20ispis&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih magistrskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=3D+štampa&submit=&locale-attribute=en)

[Primeri magisterijev iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%283D%20AND%20printing%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/bib/search?q=3d+tisk&db=cobib&mat=allmaterials&cof=0_105b-v&cof=0_105b-r&cof=0_105f-z&cof=0_105b-j&cof=0_105b-v1&cof=0_105b-r4&tyf=0_knj&tyf=0_cla&tyf=0_evir&tyf=0_ser&max=100)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=3d+tisk&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=3D+printing&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=3D+printing)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=3D+printing)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=3D+printing)
...
site:oatd.org 3D printing

site:oatd.org 3D printing AND 3D manufacturing
...
Za kakovostno napisano magistrsko nalogo o 3D TISKU imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "3d tisk".

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=3D+printing&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=3D+printing)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=3D+printing)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=3D+printing&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo 3D tiska?

Pri raziskovanju 3D tiska lahko uporabiš kombinacijo tehničnih in empiričnih pristopov. Izvedi strukturirane intervjuje s strokovnjaki iz industrije. Analiziraj tehnične specifikacije različnih 3D tiskalnikov. Dodaj eksperimentalno testiranje materialov in primerjavo učinkovitosti različnih tehnik tiskanja.

### Ali je za raziskavo 3D tiska primernejša kvalitativna ali kvantitativna metodologija?

Za raziskavo 3D tiska je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje meritve natančnosti, hitrosti in stroškov tiskanja. Kvalitativni del naj obsega analizo inovativnih aplikacij, intervjuje s strokovnjaki in študije primerov iz različnih industrijskih panog.

### Kako opredeliti omejitve raziskave pri proučevanju 3D tiska?

V dispoziciji zapiši tehnične omejitve razpoložljive opreme. Navedi omejitve pri dostopu do najnovejših tehnologij. Opredeli časovni okvir raziskave. Dodaj omejitve glede razpoložljivosti materialov in specifičnih tiskalnikov. Pojasni tudi morebitne finančne in prostorske omejitve.

### Kako pravilno zastaviti hipoteze o 3D tisku?

Hipoteze morajo biti specifične in merljive. Primer: "Napredne 3D tiskalne tehnologije bodo znižale produktivne stroške za 40%". Ali: "Uporaba novih kompozitnih materialov bo povečala trdnost izdelkov za 35%". Možna je tudi: "Implementacija strojnega učenja bo izboljšala natančnost tiskanja za 50%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri 3D tisku ključnega pomena. Vključi 8 do 12 najnovejših mednarodnih raziskav. Dodaj primere iz vodilnih tehnoloških inštitutov. Posebej pomembne so raziskave o naprednih materialih in industrijskih aplikacijah 3D tiska.

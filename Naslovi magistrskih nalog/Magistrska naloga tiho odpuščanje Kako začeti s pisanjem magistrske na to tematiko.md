---
Naslov objave: "Magistrska naloga tiho odpuščanje: Kako začeti s pisanjem magistrske na to tematiko?"
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-14T14:17:31+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Magistrska naloga tiho odpuščanje: Kako začeti s pisanjem magistrske na to tematiko?

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/magistrska-naloga-tiho-odpuscanje/](https://diplomska-magistrska.si/magistrska-naloga-tiho-odpuscanje/)
...
Soočili ste se torej z izzivom, da morate začeti s pisanjem magistrskega dela o TIHEM ODPUŠČANJU.

Obstaja velika verjetnost, da vam bo ta prispevek tako koristen, da ga boste dodali med svoje zaznamke.

Kakorkoli že, moj cilj je, da iz te vsebine potegnete maksimalno korist in drastično skrajšate čas izdelave magistrske naloge o TIHEM ODPUŠČANJU.
...
- kako iskati že uspešne magistrske naloge, ki so prav tako raziskovale področje o "TIHEM ODPUŠČANJU"
- kako in kje najti magistrske naloge, ki se dotikajo podobne tematike
- vas vodi skozi postopek iskanja literature na temo *"tiho odpuščanje"* – knjig, priročnikov, znanstvenih člankov in tujih virov

Ker podobno kot mnogi najbrž niste prepričani, kako se lotiti pisanja svojega dela, vam lahko svetujem, da je najprimerneje pričeti z raziskovanjem spletnih virov in pregledom že uspešnih nalog na temo tiho odpuščanje.
...
**tiho odpuščanje** je tema, s katero ste verjetno že seznanjeni in je morda del vašega vsakdana, naj bo to preko študija, osebnih zanimanj, prostočasnih dejavnosti ali osebnih izkušenj.
Če je tema ***"tiho odpuščanje"*** le začetna ideja in še niste določili natančnega naslova za svoje magistrsko delo, imam za vas dobro novico. Ob koncu te objave boste našli nasvete, ki vam bodo pomagali "brainstormati" ideje vašega (bodočega) zaključnega dela.

## Kako se lotiti pisanja dispozicije o "TIHEM ODPUŠČANJU"?

Vsaka magistrska naloga o "TIHEM ODPUŠČANJU" se začne z dispozicijo, ki služi kot natančno določen načrt vašega dela. Ta dokument mora obvezno vsebovati jasno definirane cilje in namen, izbrano raziskovalno metodologijo, predvideno kazalo vsebine, seznam literature za preučevanje ter jasno opredeljen raziskovalni problem z njegovimi omejitvami.
...
## Kateri tip raziskovalne metode izbrati za nalogo o TIHEM ODPUŠČANJU?

Pri raziskovanju teme o "TIHEM ODPUŠČANJU" se boste morali odločiti za ustrezen raziskovalni pristop. V slovenskem visokošolskem prostoru se naloge tipično delijo na teh pet osnovnih metodoloških vrst - seveda si vi izberite tistega, ki je za vaš naslov oz. tematiko najprimernejši in vam omogoča najhitrejšo pot do zaključka.
...
Ko prijavljate temo o "TIHEM ODPUŠČANJU", bodite izjemno previdni pri izbiri mentorja. Najbolj varna izbira je profesor, ki velja za "prizanesljivega" oziroma še bolje, pasivnega ocenjevalca. Če ima vaš izbrani mentor zraven predavanja na šoli še svoje podjetje ali predava drugje na kakšnem drugem faksu, ste zadeli "terno" – zaradi pomanjkanja časa se namreč takšni mentorji redko spuščajo v malenkosti in ne komplicirajo. Še en pomemben nasvet: strogo se izogibajte dodajanju somentorjev. Več vključenih ljudi pomeni več različnih "muh" in zahtev, kar lahko izdelavo vaše magistrske naloge zavleče za več mesecev.

## Brskanje po tujih magistrskih nalogah

[Pregled sorodnih magistrskih del, ki so bila kadarkoli objavljena v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:tiho+odpuščanje;1:20:209;)

[Tukaj boste našli primere hrvaških magistrskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=tiho%20otpuštanje&ct%5B%5D=thesis&yr_from=&yr_to=)

[Tukaj boste našli primere srbskih magistrskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=tiho+otpuštanje&submit=&locale-attribute=en)

[Primeri magisterijev iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28quiet%20AND%20firing%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjižnično gradivo (COBISS in šolska knjižnica)](https://plus.cobiss.net/cobiss/si/sl/bib/search?q=tiho+odpuščanje&db=cobib&mat=allmaterials&cof=0_105b-v&cof=0_105b-r&cof=0_105f-z&cof=0_105b-j&cof=0_105b-v1&cof=0_105b-r4&tyf=0_knj&tyf=0_cla&tyf=0_evir&tyf=0_ser&max=100)
...
[**Anna's Archive** (obsežna zbirka skoraj vse akademske literature)](https://annas-archive.gl/search?q=quiet+firing)

[**Anna's Archive (alternativna povezava 1)** (povezava .pk)](https://annas-archive.pk/search?q=quiet+firing)

[**Anna's Archive (alternativna povezava 2)** (povezava .gd)](https://annas-archive.gd/search?q=quiet+firing)
...
site:oatd.org quiet firing AND covert dismissal
...
Pri iskanju literature za magistrsko o TIHEM ODPUŠČANJU lahko uporabite različne vire. Spodaj imate pripravljen seznam baz in pa direktnih povezav do le-teh, ki bodo samodejno sprožile iskanje po tovrstnih zbirkah na temo o "tiho odpuščanje".

[Iskanje na **Semantic Scholar** (angleški članki od 2021 naprej s prostim dostopom do PDF)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=quiet+firing&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (globalna platforma za raziskovalce)](https://www.researchgate.net/search/publication?q=quiet+firing)

[Iskanje na **CORE** (zbirka z več kot 300 milijoni odprtodostopnih člankov in člankov)](https://core.ac.uk/search?q=quiet+firing)

[Iskanje na **BASE** (akademski iskalnik z več kot 400 milijoni dokumentov)](https://www.base-search.net/Search/Results?lookfor=quiet+firing&type=all)
...
Pri raziskovanju tihega odpuščanja uporabi kombinacijo pristopov. Izvedi anonimne spletne vprašalnike med zaposlenimi za ugotavljanje prisotnosti tega pojava. Uporabi strukturirane intervjuje s kadrovskimi strokovnjaki in vodji oddelkov za poglobljeno razumevanje namernih ali nenamernih praks. Dodaj tudi analizo fluktuacije zaposlenih in izhodnih intervjujev v izbranem podjetju.

### Ali je za raziskavo tihega odpuščanja primernejša kvalitativna ali kvantitativna metodologija?

Pri proučevanju tihega odpuščanja je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo ravni zadovoljstva pri delu, napredovanj in fluktuacije kadrov. Kvalitativni del naj obsega poglobljene intervjuje z zaposlenimi, ki so doživeli marginalizacijo na delovnem mestu, ter študije posameznih primerov.

### Kako opredeliti omejitve raziskave pri proučevanju tihega odpuščanja?

V dispoziciji jasno zapiši omejitve pri zbiranju podatkov, saj gre za zelo občutljivo in prikrito temo. Navedi tveganje nizkega odziva anketirancev ali neiskrenih odgovorov vodstva. Opredeli časovni okvir raziskave. Zapiši tudi omejitve pri dostopu do internih kadrovskih dokumentov podjetja in pojasni etične vidike raziskovanja anonimnih virov.

### Kako pravilno zastaviti hipoteze o tihem odpuščanju?

Hipoteze morajo biti konkretne in merljive. Primer: "Zaposleni, ki zaznavajo elemente tihega odpuščanja, imajo za 40 % nižjo delovno motivacijo". Ali: "Transparentna komunikacija vodstva bo zmanjšala občutek marginalizacije pri delu za 30 %". Možna je tudi: "Prisotnost tihega odpuščanja povečuje tveganje za fluktuacijo kadrov za 50 %".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tej temi zelo priporočljiva, saj gre za prepoznan globalen HR trend. Vključi vsaj 8 do 10 najnovejših mednarodnih raziskav o pojavu quiet firing. Dodaj primere dobrih kadrovskih praks iz tujih korporativnih okolij. Posebej pomembne so raziskave o vplivu toksičnega vodenja na zadrževanje talentov.

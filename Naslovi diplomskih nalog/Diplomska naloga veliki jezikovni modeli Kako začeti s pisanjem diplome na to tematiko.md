---
Naslov objave: "Diplomska naloga veliki jezikovni modeli: Kako začeti s pisanjem diplome na to tematiko?"
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-14T17:18:21+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga veliki jezikovni modeli: Kako začeti s pisanjem diplome na to tematiko?

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-veliki-jezikovni-modeli/](https://diplomska-magistrska.si/diplomska-naloga-veliki-jezikovni-modeli/)
...
Soočili ste se torej z izzivom, da morate začeti s pisanjem diplomskega dela o VELIKIH JEZIKOVNIH MODELIH.

Obstaja velika verjetnost, da vam bo ta prispevek tako koristen, da ga boste dodali med svoje zaznamke.

Kakorkoli že, moj cilj je, da iz te vsebine potegnete maksimalno korist in drastično skrajšate čas izdelave diplomske naloge o VELIKIH JEZIKOVNIH MODELIH.
...
- kako iskati že uspešne diplomske naloge, ki so prav tako raziskovale področje o "VELIKIH JEZIKOVNIH MODELIH"
- kako in kje najti diplomske naloge, ki se dotikajo podobne tematike
- kako skozi postopek iskanja literature na temo *"veliki jezikovni modeli"* poiskati knjige, priročnike, znanstvene članke in tuje vire

Ker podobno kot mnogi najbrž niste prepričani, kako se lotiti pisanja svojega dela, vam lahko svetujem, da je najprimerneje pričeti z raziskovanjem spletnih virov in pregledom že uspešnih nalog na temo veliki jezikovni modeli.
...
**veliki jezikovni modeli** je tema, s katero ste verjetno že seznanjeni in je morda del vašega vsakdana, naj bo to preko študija, osebnih zanimanj, prostočasnih dejavnosti ali osebnih izkušenj.
Če je tema ***"veliki jezikovni modeli"*** le začetna ideja in še niste določili natančnega naslova za svoje diplomsko delo, imam za vas dobro novico. Ob koncu te objave boste našli nasvete, ki vam bodo pomagali "brainstormati" ideje vašega (bodočega) zaključnega dela.

## Kako se lotiti pisanja dispozicije o "VELIKIH JEZIKOVNIH MODELIH"?

Vsaka diplomska naloga o "VELIKIH JEZIKOVNIH MODELIH" se začne z dispozicijo, ki služi kot natančno določen načrt vašega dela. Ta dokument mora obvezno vsebovati jasno definirane cilje in namen, izbrano raziskovalno metodologijo, predvideno kazalo vsebine, seznam literature za preučevanje ter jasno opredeljen raziskovalni problem z njegovimi omejitvami.
...
## Kateri tip raziskovalne metode izbrati za nalogo o VELIKIH JEZIKOVNIH MODELIH?

Pri raziskovanju teme o "VELIKIH JEZIKOVNIH MODELIH" se boste morali odločiti za ustrezen raziskovalni pristop. V slovenskem visokošolskem prostoru se naloge tipično delijo na teh pet osnovnih metodoloških vrst - seveda si vi izberite tistega, ki je za vaš naslov oz. tematiko najprimernejši in vam omogoča najhitrejšo pot do zaključka.
...
Ko prijavljate temo o "VELIKIH JEZIKOVNIH MODELIH", bodite izjemno previdni pri izbiri mentorja. Najbolj varna izbira je profesor, ki velja za "prizanesljivega" oziroma morda celo pasivnega ocenjevalca. Če ima vaš izbrani mentor zraven še svoje podjetje ali predava drugje na kakšnem drugem faksu, ste zadeli "terno" – zaradi pomanjkanja časa se namreč takšni mentorji redko spuščajo v malenkosti in ne komplicirajo. Še en pomemben nasvet: strogo se izogibajte dodajanju somentorjev. Več vključenih ljudi pomeni več različnih "muh" in zahtev, kar lahko izdelavo vaše diplomske naloge zavleče za več mesecev.

## Brskanje po tujih diplomskih nalogah

[Pregled sorodnih diplomskih del, ki so bila kadarkoli objavljena v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:veliki+jezikovni+modeli;1:20:211;)

[Tukaj boste našli primere hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=veliki%20jezični%20modeli&ct%5B%5D=thesis&yr_from=&yr_to=)

[Tukaj boste našli primere srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=veliki+jezički+modeli&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28large%20AND%20language%20AND%20models%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjižnično gradivo (COBISS in šolska knjižnica)](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=veliki+jezikovni+modeli&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=veliki+jezikovni+modeli&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=large+language+models&hl=en&as_sdt=0,5)

[**Anna's Archive** (obsežna zbirka skoraj vse akademske literature)](https://annas-archive.gl/search?q=large+language+models)

[**Anna's Archive (alternativna povezava 1)** (povezava .pk)](https://annas-archive.pk/search?q=large+language+models)

[**Anna's Archive (alternativna povezava 2)** (povezava .gd)](https://annas-archive.gd/search?q=large+language+models)
...
site:oatd.org large language models

site:oatd.org large language models AND LLM
...
Pri iskanju literature za diplomsko o VELIKIH JEZIKOVNIH MODELIH lahko uporabite različne vire. Spodaj imate pripravljen seznam baz in pa direktnih povezav do le-teh, ki bodo samodejno sprožile iskanje po tovrstnih zbirkah na temo o "veliki jezikovni modeli".

### Znanstvene in akademske članke (Google Učenjak, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleški članki od 2021 naprej s prostim dostopom do PDF)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=large+language+models&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (globalna platforma za raziskovalce)](https://www.researchgate.net/search/publication?q=large+language+models)

[Iskanje na **CORE** (zbirka z več kot 300 milijoni odprtodostopnih člankov in člankov)](https://core.ac.uk/search?q=large+language+models)

[Iskanje na **BASE** (akademski iskalnik z več kot 400 milijoni dokumentov)](https://www.base-search.net/Search/Results?lookfor=large+language+models&type=all)
...
### Ali je za raziskavo jezikovnih modelov primernejša kvalitativna ali kvantitativna metodologija?

Pri raziskovanju jezikovnih modelov je nujna kombinirana metodologija. V kvantitativnem delu analiziraj metrike uspešnosti, porabo računalniških virov in točnost rezultatov. V kvalitativnem delu izvedi poglobljeno analizo kakovosti generiranih besedil in etičnih vidikov.

### Kako opredeliti omejitve raziskave pri proučevanju jezikovnih modelov?

V dispoziciji zapiši tehnične omejitve računalniške infrastrukture. Navedi omejitve pri dostopu do API-jev in modelov. Zapiši omejitve glede velikosti podatkovnih množic za učenje. Opredeli tudi jezikovne omejitve pri analizi slovenščine.

### Kako pravilno zastaviti hipoteze o jezikovnih modelih?

Hipoteze naj bodo merljive in konkretne. Primer: "Specializiran jezikovni model bo izboljšal točnost prevajanja strokovnih besedil za 35%". Ali: "Fino uglašen model bo zmanjšal pristranskost za 40%". Možna je tudi: "Implementacija varoval bo znižala toksičnost rezultatov za 60%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Pri jezikovnih modelih je primerjava s tujimi raziskavami nujna. Vključi vsaj 10 najnovejših raziskav vodilnih AI laboratorijev. Dodaj študije o uporabi modelov v različnih jezikih. Posebej pomembne so raziskave o etičnih vidikih in varnosti modelov.

### Kako zagotoviti veljavnost rezultatov pri testiranju modelov?

Za veljavnost rezultatov uporabi standardizirane evalvacijske metrike. Izvedi testiranje na več neodvisnih podatkovnih množicah. Vključi človeške ocenjevalce za kvalitativno evalvacijo. Rezultate primerjaj z obstoječimi modeli in dokumentiraj vse parametre testiranja.

---
Naslov objave: "Diplomska naloga programska oprema: Praktični nasveti za uspešno nalogo s to temo."
...
# Diplomska naloga programska oprema: Praktični nasveti za uspešno nalogo s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-programska-oprema/](https://diplomska-magistrska.si/diplomska-naloga-programska-oprema/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o PROGRAMSKI OPREMI.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o PROGRAMSKI OPREMI na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o PROGRAMSKI OPREMI
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o PROGRAMSKI OPREMI poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (programska oprema) že bile uspešne.
...
**programska oprema** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"programska oprema"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o PROGRAMSKI OPREMI

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o PROGRAMSKI OPREMI. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o PROGRAMSKI OPREMI boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:programska+oprema;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=programska%20oprema&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=programski+softver&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28software%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=programska+oprema&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=programska+oprema&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=software&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=software)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=software)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=software)
...
site:oatd.org software

site:oatd.org software AND software solution
...
Za kakovostno napisano diplomsko nalogo o PROGRAMSKI OPREMI imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "programska oprema".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=software&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=software)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=software)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=software&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo programske opreme?

Pri analizi programske opreme lahko uporabiš več pristopov. Izvedi strukturirane intervjuje z razvijalci in vodji projektov. Analiziraj obstoječo projektno dokumentacijo. Dodaj testiranje programske opreme v kontroliranem okolju. Vključi tudi analizo verzij in razvojnih ciklov.

### Ali je za raziskavo programske opreme primernejša kvalitativna ali kvantitativna metodologija?

Za raziskavo programske opreme je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje meritve zmogljivosti, odzivnih časov in napak v kodi. Kvalitativni del naj obsega poglobljene intervjuje z razvijalci in analizo razvojnih izzivov.

### Kako opredeliti omejitve raziskave pri proučevanju programske opreme?

V dispoziciji zapiši tehnične omejitve testnega okolja. Navedi omejitve pri dostopu do izvorne kode. Opredeli časovni okvir analize razvojnega procesa. Dodaj omejitve glede zaupnosti podatkov in poslovnih skrivnosti podjetja.

### Kako pravilno zastaviti hipoteze o razvoju programske opreme?

Hipoteze morajo biti natančne in merljive. Primer: "Uvedba agilnih metod bo skrajšala razvojni cikel za 40%". Ali: "Implementacija DevOps praks bo zmanjšala število napak za 35%". Možna je tudi: "Avtomatizirano testiranje bo povečalo kakovost kode za 50%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je zelo priporočljiva. Vključi 8 do 10 najnovejših mednarodnih raziskav s področja razvoja programske opreme. Dodaj študije primerov vodilnih tehnoloških podjetij. Posebej pomembne so raziskave o novih razvojnih metodologijah in trendih.

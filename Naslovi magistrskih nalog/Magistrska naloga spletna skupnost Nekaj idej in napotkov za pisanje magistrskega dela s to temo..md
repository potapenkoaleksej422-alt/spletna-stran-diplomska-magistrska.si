---
Naslov objave: "Magistrska naloga spletna skupnost: Nekaj idej in napotkov za pisanje magistrskega dela s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-16T11:16:15+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Magistrska naloga spletna skupnost: Nekaj idej in napotkov za pisanje magistrskega dela s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/magistrska-naloga-spletna-skupnost/](https://diplomska-magistrska.si/magistrska-naloga-spletna-skupnost/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja magistrske naloge o SPLETNI SKUPNOSTI.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega magistrskega dela o SPLETNI SKUPNOSTI na absolutni minimum.
...
- kako poiskati uspešne magistrske naloge drugih študentov, ki so prav tako imeli temo o SPLETNI SKUPNOSTI
- kje iskati magistrske naloge s podobno temo (in kako)
- vam pokaže kje in kako na temo spletna skupnost poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (spletna skupnost) že bile uspešne.
...
**spletna skupnost** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"spletna skupnost"*** zgolj iztočnica ali misel in točnega naslova za magistrsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče magistrske naloge.

## Priprava dispozicije za magistrsko nalogo o SPLETNI SKUPNOSTI

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem magistrske naloge o SPLETNI SKUPNOSTI. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o SPLETNI SKUPNOSTI boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča magistriranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše magistrske naloge o SPLETNI SKUPNOSTI. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj pragmatični, življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih magistrskih nalog

[Primeri vseh kadarkoli objavljenih magistrskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:spletna+skupnost;1:20:209;)

[Primeri hrvaških magistrskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=internetska%20zajednica&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih magistrskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=onlajn+zajednica&submit=&locale-attribute=en)

[Primeri magisterijev iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28online%20AND%20community%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/bib/search?q=spletna+skupnost&db=cobib&mat=allmaterials&cof=0_105b-v&cof=0_105b-r&cof=0_105f-z&cof=0_105b-j&cof=0_105b-v1&cof=0_105b-r4&tyf=0_knj&tyf=0_cla&tyf=0_evir&tyf=0_ser&max=100)
...
[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=online+community)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=online+community)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=online+community)
...
site:oatd.org online community AND digital community
...
Za kakovostno napisano magistrsko nalogo o SPLETNI SKUPNOSTI imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "spletna skupnost".

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=online+community&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=online+community)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=online+community)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=online+community&type=all)
...
Pri raziskovanju spletne skupnosti uporabi kombinacijo pristopov. Izvedi spletne ankete med člani za merjenje zadovoljstva in motivacije. Uporabi analizo vsebine (netnografijo) za preučevanje interakcij v forumih. Dodaj še opazovanje z udeležbo in občasne poglobljene intervjuje z moderatorji ali ključnimi mnenjskimi voditelji v skupnosti.

### Ali je za raziskavo spletne skupnosti primernejša kvalitativna ali kvantitativna metodologija?

Za proučevanje spletne skupnosti je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo demografskih podatkov, pogostosti objav in vključevalnosti članov. Kvalitativni del naj obsega netnografsko opazovanje digitalnega okolja, analizo diskurza in razumevanje globljih motivov za aktivno participacijo uporabnikov.

### Kako opredeliti omejitve raziskave pri proučevanju spletne skupnosti?

V dispoziciji jasno zapiši omejitve dostopa do zaprtih ali zasebnih podatkov članov. Navedi omejitve reprezentativnosti vzorca, saj na ankete pogosto odgovarjajo le najbolj aktivni člani. Opredeli časovni okvir analiziranja objav, na primer zadnjih šest mesecev. Upoštevaj tudi tehnične omejitve platform in etična pravila varovanja zasebnosti na spletu.

### Kako pravilno zastaviti hipoteze o spletni skupnosti?

Hipoteze morajo biti konkretne in merljive. Primer: "Uvedba elementov igrifikacije in sistema nagrajevanja bo povečala aktivnost uporabnikov za 35%". Ali: "Močan občutek pripadnosti spletni skupnosti bo izboljšal zvestobo blagovni znamki za 25%". Možna je tudi: "Aktivno moderiranje vsebin bo zmanjšalo število neprimernih objav za 40%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri strukturah spletnih skupnosti zelo priporočljiva. Vključi vsaj 8 do 12 najnovejših mednarodnih raziskav o digitalnih skupnostih in socialnih omrežjih. Dodaj primere uspešnih globalnih modelov povezovanja uporabnikov. Posebej dragocene so zahodne raziskave o vedenju potrošnikov v virtualnem okolju.

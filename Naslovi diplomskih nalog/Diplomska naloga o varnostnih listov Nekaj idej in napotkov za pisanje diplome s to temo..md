---
Naslov objave: "Diplomska naloga o varnostnih listov: Nekaj idej in napotkov za pisanje diplome s to temo."
...
# Diplomska naloga o varnostnih listov: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-o-varnostnih-listov/](https://diplomska-magistrska.si/diplomska-naloga-o-varnostnih-listov/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o VARNOSTNIH LISTIH.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o VARNOSTNIH LISTIH na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o VARNOSTNIH LISTIH
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o VARNOSTNIH LISTIH poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (o varnostnih listov) že bile uspešne.
...
**o varnostnih listov** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"o varnostnih listov"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o VARNOSTNIH LISTIH

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o VARNOSTNIH LISTIH. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o VARNOSTNIH LISTIH boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o VARNOSTNIH LISTIH. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:o+varnostnih+listov;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=o%20sigurnosnim%20listovima&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=o+bezbednosnim+listovima&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28safety%20AND%20data%20AND%20sheets%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=o+varnostnih+listov&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=o+varnostnih+listov&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=safety+data+sheets&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=safety+data+sheets)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=safety+data+sheets)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=safety+data+sheets)
...
site:oatd.org safety data sheets

site:oatd.org safety data sheets AND safety data sheet
...
Za kakovostno napisano diplomsko nalogo o VARNOSTNIH LISTIH imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "o varnostnih listov".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=safety+data+sheets&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=safety+data+sheets)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=safety+data+sheets)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=safety+data+sheets&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo varnostnih listov?

Pri analizi varnostnih listov uporabi kombinacijo tehničnih in dokumentacijskih pristopov. Izvedi sistematični pregled obstoječih varnostnih listov v podjetju. Uporabi strukturirane intervjuje s strokovnjaki za varnost in zdravje pri delu. Dodaj analizo skladnosti z veljavno zakonodajo in mednarodnimi standardi.

### Ali je za raziskavo varnostnih listov primernejša kvalitativna ali kvantitativna metodologija?

Pri varnostnih listih je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo skladnosti in pogostosti pomanjkljivosti. Kvalitativni del naj obsega poglobljeno analizo vsebine, interpretacijo standardov in študije primerov.

### Kako opredeliti omejitve raziskave pri proučevanju varnostnih listov?

V dispoziciji zapiši omejitve dostopa do dokumentacije. Navedi omejitve pri pregledu varnostnih listov različnih oddelkov. Opredeli časovni okvir raziskave. Dodaj omejitve glede zaupnosti podatkov in industrijskih standardov.

### Kako pravilno zastaviti hipoteze o varnostnih listih?

Hipoteze morajo biti specifične in merljive. Primer: "Posodobitev varnostnih listov bo zmanjšala potencialna tveganja za 40%". Ali: "Digitalizacija varnostnih listov bo povečala učinkovitost pregledovanja za 35%". Možna je tudi: "Standardiziran format bo izboljšal razumljivost za 50%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je zelo priporočljiva. Vključi 8 do 10 mednarodnih raziskav o varnostnih listih. Dodaj primerjave z EU standardi. Posebej pomembne so raziskave o najboljših praksah in digitalnih rešitvah.

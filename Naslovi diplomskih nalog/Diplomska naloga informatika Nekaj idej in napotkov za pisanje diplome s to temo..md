---
Naslov objave: "Diplomska naloga informatika: Nekaj idej in napotkov za pisanje diplome s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-13T11:29:03+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga informatika: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-informatika/](https://diplomska-magistrska.si/diplomska-naloga-informatika/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o INFORMATIKI.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o INFORMATIKI na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o INFORMATIKI
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o INFORMATIKI poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (informatika) že bile uspešne.
...
**informatika** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"informatika"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o INFORMATIKI

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o INFORMATIKI. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o INFORMATIKI boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o INFORMATIKI. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:informatika;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=informatika&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=informatika&submit=&locale-attribute=en)
...
[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=informatika&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=informatika&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=computer+science&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=computer+science)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=computer+science)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=computer+science)
...
site:oatd.org computer science AND computing
...
Za kakovostno napisano diplomsko nalogo o INFORMATIKI imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "informatika".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=computer+science&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=computer+science)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=computer+science)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=computer+science&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo informatike?

Pri raziskovanju informatike lahko uporabiš kombinacijo tehničnih in empiričnih pristopov. Izvedi strukturirane intervjuje s strokovnjaki iz IT oddelkov. Analiziraj obstoječe informacijske sisteme in njihovo učinkovitost. Dodaj tudi opazovanje implementacije digitalnih rešitev in testiranja programskih orodij.

### Ali je za raziskavo informatike primernejša kvalitativna ali kvantitativna metodologija?

Za informatiko je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje meritve učinkovitosti sistemov, analizo performančnih kazalnikov in statistično obdelavo podatkov. Kvalitativni del naj obsega poglobljene intervjuje s strokovnjaki in analizo študij primerov.

### Kako opredeliti omejitve raziskave pri proučevanju informatike?

V dispoziciji zapiši tehnične omejitve testnega okolja. Navedi omejitve pri dostopu do produkcijskih sistemov. Opredeli časovni okvir raziskave. Dodaj omejitve glede varovanja poslovnih skrivnosti in zasebnosti podatkov. Pojasni tudi morebitne omejitve strojne in programske opreme.

### Kako pravilno zastaviti hipoteze o informatskih rešitvah?

Hipoteze morajo biti natančne in merljive. Primer: "Implementacija oblačnih storitev bo znižala stroške infrastrukture za 40%". Ali: "Uvedba umetne inteligence bo povečala učinkovitost procesov za 35%". Možna je tudi: "Nadgradnja varnostnih sistemov bo zmanjšala kibernetske napade za 50%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri informatiki ključnega pomena. Vključi 8 do 10 najnovejših mednarodnih raziskav. Dodaj študije vodilnih tehnoloških podjetij in raziskovalnih inštitutov. Posebej pomembne so raziskave o emerging tehnologijah in digitalnih transformacijah.

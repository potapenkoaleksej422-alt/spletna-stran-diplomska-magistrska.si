---
Naslov objave: "Diplomska naloga glasbena pedagogika: Nekaj idej in napotkov za pisanje diplome s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-12T10:10:43+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga glasbena pedagogika: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-glasbena-pedagogika/](https://diplomska-magistrska.si/diplomska-naloga-glasbena-pedagogika/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o GLASBENI PEDAGOGIKI.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o GLASBENI PEDAGOGIKI na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o GLASBENI PEDAGOGIKI
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o GLASBENI PEDAGOGIKI poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (glasbena pedagogika) že bile uspešne.
...
**glasbena pedagogika** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"glasbena pedagogika"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o GLASBENI PEDAGOGIKI

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o GLASBENI PEDAGOGIKI. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o GLASBENI PEDAGOGIKI boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o GLASBENI PEDAGOGIKI. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:glasbena+pedagogika;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=glazbena%20pedagogika&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=muzička+pedagogija&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28music%20AND%20pedagogy%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=glasbena+pedagogika&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=glasbena+pedagogika&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=music+pedagogy&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=music+pedagogy)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=music+pedagogy)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=music+pedagogy)
...
site:oatd.org music pedagogy

site:oatd.org music pedagogy AND music education
...
Za kakovostno napisano diplomsko nalogo o GLASBENI PEDAGOGIKI imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "glasbena pedagogika".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=music+pedagogy&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=music+pedagogy)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=music+pedagogy)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=music+pedagogy&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo glasbene pedagogike?

Pri raziskovanju glasbene pedagogike lahko uporabiš kombinacijo kvalitativnih in kvantitativnih pristopov. Izvedi strukturirane intervjuje z glasbenimi pedagogi, opazuj poučevanje v glasbenih šolah in analiziraj učne programe. Dodaj tudi ankete med učenci in starši za pridobitev celovitega vpogleda v pedagoške prakse.

### Ali je za raziskavo glasbene pedagogike primernejša kvalitativna ali kvantitativna metodologija?

Najprimernejša je kombinirana metodologija. V kvantitativnem delu analiziraj statistične podatke o učnih dosežkih, napredku učencev in učinkovitosti poučevanja. V kvalitativnem delu izvedi poglobljene intervjuje z učitelji in analizo pedagoških pristopov.

### Kako opredeliti omejitve raziskave pri proučevanju glasbene pedagogike?

V dispoziciji jasno zapiši omejitve dostopa do glasbenih šol in učnih programov. Navedi starostno skupino učencev, ki jo boš preučeval. Opredeli časovni okvir raziskave in geografsko področje. Dodaj tudi omejitve pri pridobivanju soglasij in varstvu osebnih podatkov.

### Kako pravilno zastaviti hipoteze o glasbeni pedagogiki?

Pri hipotezah bodi konkreten in merljiv. Primer: "Individualni glasbeni pouk bo povečal motivacijo učencev za 40%". Ali: "Interdisciplinarni pristop bo izboljšal glasbene kompetence za 30%". Možna je tudi: "Digitalna orodja bodo povečala učinkovitost poučevanja za 25%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je zelo priporočljiva. Vključi vsaj 8 do 12 mednarodnih raziskav s področja glasbene pedagogike. Dodaj primere inovativnih pedagoških pristopov iz vodilnih glasbenih šol in akademij. Posebej pomembne so raziskave o vplivu glasbe na kognitivni razvoj.

---
Naslov objave: "Diplomska naloga zamaščenost jeter: Nekaj idej in napotkov za pisanje diplome s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-13T14:56:22+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga zamaščenost jeter: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-zamascenost-jeter/](https://diplomska-magistrska.si/diplomska-naloga-zamascenost-jeter/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o ZAMAŠČENOSTI JETER.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o ZAMAŠČENOSTI JETER na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o ZAMAŠČENOSTI JETER
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o ZAMAŠČENOSTI JETER poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (zamaščenost jeter) že bile uspešne.
...
**zamaščenost jeter** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"zamaščenost jeter"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o ZAMAŠČENOSTI JETER

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o ZAMAŠČENOSTI JETER. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o ZAMAŠČENOSTI JETER boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o ZAMAŠČENOSTI JETER. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:zamaščenost+jeter;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=zatrpanost%20jetre&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=zamašćenost+jetre&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28fatty%20AND%20liver%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=zamaščenost+jeter&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=zamaščenost+jeter&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=fatty+liver&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=fatty+liver)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=fatty+liver)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=fatty+liver)
...
site:oatd.org fatty liver

site:oatd.org fatty liver AND Fatty liver disease
...
Za kakovostno napisano diplomsko nalogo o ZAMAŠČENOSTI JETER imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "zamaščenost jeter".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=fatty+liver&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=fatty+liver)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=fatty+liver)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=fatty+liver&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo zamaščenosti jeter?

Pri raziskovanju zamaščenosti jeter uporabi kombinacijo medicinskih in laboratorijskih pristopov. Izvedi analizo zdravstvene dokumentacije pacientov. Uporabi ultrazvočne preiskave in meritve jetrnih encimov. Dodaj tudi strukturirane intervjuje z zdravniki specialisti hepatologije.

### Ali je za raziskavo zamaščenosti jeter primernejša kvalitativna ali kvantitativna metodologija?

Pri zamaščenosti jeter je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje laboratorijske teste in meritve metabolnih parametrov. Kvalitativni del naj obsega analizo dejavnikov tveganja in življenjskega sloga pacientov.

### Kako opredeliti omejitve raziskave pri proučevanju zamaščenosti jeter?

V dispoziciji zapiši omejitve pri dostopu do zdravstvene dokumentacije. Navedi starostne omejitve preučevane populacije. Opredeli geografski obseg raziskave. Dodaj etične omejitve pri zbiranju zdravstvenih podatkov. Zapiši časovni okvir zbiranja podatkov.

### Kako pravilno zastaviti hipoteze o zamaščenosti jeter?

Hipoteze morajo biti medicinsko utemeljene. Primer: "Sprememba prehranskih navad lahko zmanjša stopnjo zamaščenosti jeter za 40%". Ali: "Redna telesna aktivnost izboljša metabolne parametre za 35%". Možna je tudi: "Genetski dejavniki vplivajo na 50% tveganja za nastanek zamaščenosti jeter".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tej temi nujna. Vključi 8 do 10 mednarodnih raziskav iz zadnjih petih let. Dodaj primerjave z epidemiološkimi študijami iz vodilnih medicinskih centrov. Uporabi tudi raziskave Svetovne zdravstvene organizacije.

---
Naslov objave: "Diplomska naloga aktivno poslušanje: Nekaj idej in napotkov za pisanje diplome s to temo."
...
# Diplomska naloga aktivno poslušanje: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-aktivno-poslusanje/](https://diplomska-magistrska.si/diplomska-naloga-aktivno-poslusanje/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o AKTIVNEM POSLUŠANJU.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o AKTIVNEM POSLUŠANJU na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o AKTIVNEM POSLUŠANJU
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o AKTIVNEM POSLUŠANJU poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (aktivno poslušanje) že bile uspešne.
...
**aktivno poslušanje** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"aktivno poslušanje"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o AKTIVNEM POSLUŠANJU

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o AKTIVNEM POSLUŠANJU. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o AKTIVNEM POSLUŠANJU boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o AKTIVNEM POSLUŠANJU. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:aktivno+poslušanje;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=aktivno%20slušanje&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=aktivno+slušanje&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28active%20AND%20listening%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=aktivno+poslušanje&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=aktivno+poslušanje&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=active+listening&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=active+listening)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=active+listening)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=active+listening)
...
site:oatd.org active listening

site:oatd.org active listening AND communication
...
Za kakovostno napisano diplomsko nalogo o AKTIVNEM POSLUŠANJU imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "aktivno poslušanje".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=active+listening&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=active+listening)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=active+listening)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=active+listening&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo aktivnega poslušanja?

Pri raziskovanju aktivnega poslušanja uporabi kombinacijo kvalitativnih in kvantitativnih metod. Izvedi poglobljene intervjuje z strokovnjaki s področja komunikacije. Uporabi standardizirane vprašalnike za merjenje komunikacijskih veščin. Dodaj opazovanje vedenja v različnih komunikacijskih situacijah.

### Ali je za raziskavo aktivnega poslušanja primernejša kvalitativna ali kvantitativna metodologija?

Za raziskavo aktivnega poslušanja je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje meritve učinkovitosti komunikacije in analizo komunikacijskih vzorcev. Kvalitativni del naj obsega poglobljene intervjuje in analizo specifičnih komunikacijskih strategij.

### Kako opredeliti omejitve raziskave pri proučevanju aktivnega poslušanja?

V dispoziciji jasno zapiši omejitve raziskave. Navedi omejitve vzorca udeležencev, časovni okvir opazovanja in specifične komunikacijske kontekste. Opredeli tudi etične omejitve pri snemanju in analizi komunikacijskih interakcij. Zapiši morebitne omejitve dostopa do podatkov.

### Kako pravilno zastaviti hipoteze o aktivnem poslušanju?

Hipoteze morajo biti konkretne in merljive. Primer: "Delavnice aktivnega poslušanja bodo izboljšale medosebno komunikacijo za 40%". Ali: "Implementacija tehnik aktivnega poslušanja bo zmanjšala konflikte v delovnem okolju za 30%". Možna je tudi: "Trening aktivnega poslušanja bo povečal zadovoljstvo v medsebojnih odnosih za 35%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri aktivnem poslušanju zelo priporočljiva. Vključi vsaj 8 do 10 mednarodnih raziskav iz zadnjih petih let. Dodaj primerjave iz različnih kulturnih okolij in profesionalnih kontekstov. Posebej pomembne so raziskave o vplivu aktivnega poslušanja na medosebne odnose.

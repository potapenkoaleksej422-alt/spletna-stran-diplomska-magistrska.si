---
Naslov objave: "Diplomska naloga gibalno socialne igre: Praktični nasveti za uspešno nalogo s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-17T14:11:51+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga gibalno socialne igre: Praktični nasveti za uspešno nalogo s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-gibalno-socialne-igre/](https://diplomska-magistrska.si/diplomska-naloga-gibalno-socialne-igre/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o GIBALNO SOCIALNIH IGRAH.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o GIBALNO SOCIALNIH IGRAH na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o GIBALNO SOCIALNIH IGRAH
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o GIBALNO SOCIALNIH IGRAH poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (gibalno socialne igre) že bile uspešne.
...
**gibalno socialne igre** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"gibalno socialne igre"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o GIBALNO SOCIALNIH IGRAH

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o GIBALNO SOCIALNIH IGRAH. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o GIBALNO SOCIALNIH IGRAH boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o GIBALNO SOCIALNIH IGRAH. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:gibalno+socialne+igre;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=gibalno-socijalne%20igre&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=gibalno-socijalne+igre&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28movement%20AND%20social%20AND%20games%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=gibalno+socialne+igre&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=gibalno+socialne+igre&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=movement+social+games&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=movement+social+games)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=movement+social+games)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=movement+social+games)
...
site:oatd.org movement social games

site:oatd.org movement social games AND motor-social activities
...
Za kakovostno napisano diplomsko nalogo o GIBALNO SOCIALNIH IGRAH imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "gibalno socialne igre".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=movement+social+games&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=movement+social+games)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=movement+social+games)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=movement+social+games&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo gibalnih socialnih iger?

Pri raziskovanju gibalnih socialnih iger uporabi kombinacijo pedagoško-psiholoških pristopov. Izvedi strukturirane intervjuje z vzgojitelji in učitelji. Uporabi opazovalno metodo otrok med izvajanjem iger. Dodaj še analizo učinkov gibalnih socialnih iger na razvoj otrokovih socialnih veščin.

### Ali je za raziskavo gibalnih socialnih iger primernejša kvalitativna ali kvantitativna metodologija?

Pri proučevanju gibalnih socialnih iger je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje meritve napredka socialnih kompetenc. Kvalitativni del naj obsega poglobljene intervjuje z otroki, opazovanje njihovega vedenja in analizo interakcij med udeleženci.

### Kako opredeliti omejitve raziskave pri proučevanju gibalnih socialnih iger?

V dispoziciji zapiši starostne omejitve vzorca otrok. Navedi omejitve pri izbiri vrtca ali šole. Opredeli časovni okvir opazovanja. Omeni omejitve pri interpretaciji rezultatov. Dodaj tudi etične omejitve pri delu z otroki in varstvu osebnih podatkov.

### Kako pravilno zastaviti hipoteze o gibalnih socialnih igrah?

Hipoteze naj bodo razvojno usmerjene in merljive. Primer: "Gibalne socialne igre povečajo socialno interakcijo otrok za 35%". Ali: "Skupinske gibalne aktivnosti izboljšajo komunikacijske veščine za 40%". Možna je tudi: "Redna izvedba socialnih iger zmanjša konflikte med otroki za 25%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je nujna. Vključi 8 do 12 mednarodnih raziskav o vplivu gibalnih socialnih iger. Dodaj študije iz vodilnih pedagoških inštitutov. Posebej pomembne so longitudinalne raziskave o dolgoročnih učinkih.

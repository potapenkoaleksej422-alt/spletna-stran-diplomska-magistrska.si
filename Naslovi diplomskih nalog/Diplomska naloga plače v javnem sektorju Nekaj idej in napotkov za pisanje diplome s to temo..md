---
Naslov objave: "Diplomska naloga plače v javnem sektorju: Nekaj idej in napotkov za pisanje diplome s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-16T14:48:48+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga plače v javnem sektorju: Nekaj idej in napotkov za pisanje diplome s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-place-v-javnem-sektorju/](https://diplomska-magistrska.si/diplomska-naloga-place-v-javnem-sektorju/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o PLAČAH V JAVNEM SEKTORJU.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o PLAČAH V JAVNEM SEKTORJU na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o PLAČAH V JAVNEM SEKTORJU
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o PLAČAH V JAVNEM SEKTORJU poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (plače v javnem sektorju) že bile uspešne.
...
**plače v javnem sektorju** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"plače v javnem sektorju"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o PLAČAH V JAVNEM SEKTORJU

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o PLAČAH V JAVNEM SEKTORJU. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o PLAČAH V JAVNEM SEKTORJU boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:plače+v+javnem+sektorju;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=plaće%20u%20javnom%20sektoru&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=plate+u+javnom+sektoru&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28wages%20AND%20in%20AND%20the%20AND%20public%20AND%20sector%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=plače+v+javnem+sektorju&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=plače+v+javnem+sektorju&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=wages+in+the+public+sector&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=wages+in+the+public+sector)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=wages+in+the+public+sector)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=wages+in+the+public+sector)
...
site:oatd.org wages in the public sector

site:oatd.org wages in the public sector AND public sector
...
Za kakovostno napisano diplomsko nalogo o PLAČAH V JAVNEM SEKTORJU imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "plače v javnem sektorju".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=wages+in+the+public+sector&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=wages+in+the+public+sector)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=wages+in+the+public+sector)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=wages+in+the+public+sector&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo plač v javnem sektorju?

Pri analizi plač v javnem sektorju uporabi kombinacijo pristopov. Izvedi strukturirane intervjuje z vodji kadrovskih služb in predstavniki sindikatov. Uporabi analizo obstoječe plačne dokumentacije in statistične podatke. Dodaj tudi primerjalno analizo plačnih razredov in dodatkov v različnih institucijah javnega sektorja.

### Ali je za raziskavo plač primernejša kvalitativna ali kvantitativna metodologija?

Za raziskavo plač v javnem sektorju je najprimernejša kombinirana metodologija. V kvantitativnem delu analiziraj statistične podatke o plačah, dodatkih in napredovanjih. V kvalitativnem delu izvedi poglobljene intervjuje z zaposlenimi in vodjami ter preučuj sistemske plačne ureditve.

### Kako opredeliti omejitve raziskave pri proučevanju plač v javnem sektorju?

V dispoziciji zapiši omejitve pri dostopu do plačnih podatkov. Navedi omejitve vzorca institucij javnega sektorja. Opredeli časovno obdobje analize plačnih trendov. Dodaj tudi omejitve pri pridobivanju natančnih finančnih informacij zaradi varstva osebnih podatkov.

### Kako pravilno zastaviti hipoteze o plačah v javnem sektorju?

Pri hipotezah bodi konkreten in merljiv. Primer: "Sistemsko napredovanje bo povečalo motivacijo zaposlenih za 25%". Ali: "Uvedba novih plačnih razredov bo zmanjšala fluktuacijo za 20%". Možna je tudi: "Transparentnost plačnega sistema bo izboljšala zadovoljstvo zaposlenih za 35%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tej temi zelo priporočljiva. Vključi vsaj 8 do 12 raziskav iz različnih evropskih držav. Poišči in dodaj tudi primerjave plačnih sistemov v javnem sektorju. Posebej pomembne so raziskave o učinkovitosti plačnih modelov.

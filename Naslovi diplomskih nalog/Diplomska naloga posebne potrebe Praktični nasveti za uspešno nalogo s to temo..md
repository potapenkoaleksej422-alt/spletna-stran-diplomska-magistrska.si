---
Naslov objave: "Diplomska naloga posebne potrebe: Praktični nasveti za uspešno nalogo s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-13T15:09:11+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga posebne potrebe: Praktični nasveti za uspešno nalogo s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-posebne-potrebe/](https://diplomska-magistrska.si/diplomska-naloga-posebne-potrebe/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o POSEBNIH POTREBAH.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o POSEBNIH POTREBAH na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o POSEBNIH POTREBAH
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o POSEBNIH POTREBAH poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (posebne potrebe) že bile uspešne.
...
**posebne potrebe** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"posebne potrebe"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o POSEBNIH POTREBAH

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o POSEBNIH POTREBAH. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o POSEBNIH POTREBAH boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o POSEBNIH POTREBAH. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:posebne+potrebe;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=posebne%20potrebe&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=posebne+potrebe&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28special%20AND%20needs%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=posebne+potrebe&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=posebne+potrebe&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=special+needs&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=special+needs)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=special+needs)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=special+needs)
...
site:oatd.org special needs

site:oatd.org special needs AND disability
...
Za kakovostno napisano diplomsko nalogo o POSEBNIH POTREBAH imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "posebne potrebe".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=special+needs&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=special+needs)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=special+needs)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=special+needs&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo potreb otrok s posebnimi potrebami?

Pri raziskovanju otrok s posebnimi potrebami uporabi kombinacijo kvalitativnih in kvantitativnih pristopov. Izvedi poglobljene intervjuje s specialnimi pedagogi in starši. Uporabi standardizirane diagnostične teste. Dodaj opazovanje otrok v šolskem in domačem okolju. Analiziraj tudi obstoječo dokumentacijo in individualizirane programe.

### Ali je za raziskavo otrok s posebnimi potrebami primernejša kvalitativna ali kvantitativna metodologija?

Najprimernejša je kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo pojavnosti in učinkovitosti podpornih programov. Kvalitativni del naj obsega poglobljeno razumevanje individualnih izkušenj, intervjuje s strokovnjaki in analizo študij primerov.

### Kako opredeliti omejitve raziskave pri proučevanju otrok s posebnimi potrebami?

V dispoziciji jasno zapiši etične omejitve raziskovanja. Navedi omejitve pri dostopu do osebnih podatkov. Opredeli starostno skupino in vrsto posebnih potreb. Zapiši časovni okvir raziskave. Dodaj omejitve glede varstva osebnih podatkov in zasebnosti otrok.

### Kako pravilno zastaviti hipoteze o podpori otrokom s posebnimi potrebami?

Hipoteze morajo biti merljive in etično ustrezne. Primer: "Individualizirani učni načrti povečajo učno uspešnost za 40%". Ali: "Zgodnja intervencija izboljša socialne veščine za 35%". Možna je tudi: "Inkluzivno izobraževanje zmanjša socialno izključenost za 50%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je zelo priporočljiva. Vključi 8 do 10 mednarodnih raziskav iz zadnjih petih let. Dodaj primerjave iz skandinavskih držav z naprednimi sistemi inkluzivnega izobraževanja. Uporabi tudi raziskave mednarodnih organizacij na tem področju.

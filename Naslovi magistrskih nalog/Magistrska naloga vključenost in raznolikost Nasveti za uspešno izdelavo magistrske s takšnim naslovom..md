---
Naslov objave: "Magistrska naloga vključenost in raznolikost: Nasveti za uspešno izdelavo magistrske s takšnim naslovom."
...
# Magistrska naloga vključenost in raznolikost: Nasveti za uspešno izdelavo magistrske s takšnim naslovom.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/magistrska-naloga-vkljucenost-in-raznolikost/](https://diplomska-magistrska.si/magistrska-naloga-vkljucenost-in-raznolikost/)
...
Znašli ste se torej v situaciji, ko morate pričeti z izdelavo magistrske naloge o "VKLJUČENOSTI IN RAZNOLIKOSTI".

Možno je, da vam bo ta članek služil kot odličen pripomoček in si ga boste celo shranili med priljubljene strani.

Vsekakor pa upam, da boste iz prebranega odnesli čim več ter tako čas pisanja magistrske naloge o VKLJUČENOSTI IN RAZNOLIKOSTI zmanjšali na popoln minimum.
...
- kako poiskati in prebrskati že zaključena magistrska dela študentov, ki so se morda že uspešno spopadli z izzivom tematike o "VKLJUČENOSTI IN RAZNOLIKOSTI"
- vas opremi z znanjem za učinkovito iskanje magistrskih nalog na sorodnem področju
- vam priporoči, kje in kako najti ustrezno literaturo o temi "vključenost in raznolikost", vključno z akademskimi in strokovnimi viri (knjigami, znanstvenimi članki, raziskovalnimi članki, tujimi viri, ipd.)

Ker enako kot drugi verjetno nimate jasne predstave o tem, kje začeti s sestavljanjem svojega zaključnega dela, vam lahko predlagam, da je najbolj koristno začeti z iskanjem in preučevanjem že obstoječih uspešnih nalog s tematiko "vključenost in raznolikost".
...
Ne glede na to, kako kompleksno se sliši tema "vključenost in raznolikost", bo vaša naloga na koncu vedno spadala v eno od petih klasičnih kategorij metodologij, ki se uporabljajo na slovenskih fakultetah. Seveda, za to temo ni primerna vsaka od teh petih, zato si izberite tisto, ki bo relevantna in pa predvsem - najlažja vam, da ne boste magistrske naloge pisali celo večnost.
...
Vaša pot do magisterija o tematiki VKLJUČENOSTI IN RAZNOLIKOSTI bo bistveno lažja, če boste izbrali "pragmatičnega", oziroma še bolje pasivnega mentorja. Idealni so tisti profesorji, ki zraven predavanj opravljajo še kakšno "obšolsko" dejavnost (imajo s.p. ali d.o.o.) ali pa morda predavajo še na kakšni drugi fakulteti, saj zaradi tega ne iščejo "dlake v jajcu" in so veliko bolj življenjski pri popravkih. Vsekakor pa se kolikor je to mogoče, izognite somentorjem! Prisotnost somentorja namreč vedno prinese dodatna usklajevanja, nasprotujoča si mnenja z glavnim mentorjem in podaljša vaš čas pisanja.

## Iskanje sorodnih magistrskih nalog

[Zbirka vseh relevantnih magistrskih nalog s sorodnimi temami, ki so bila kadarkoli objavljena v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:vključenost+in+raznolikost;1:20:209;)

[Primeri hrvaških magistrskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=uključenost%20i%20raznolikost&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih magistrskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=uključenost+i+raznolikost&submit=&locale-attribute=en)

[Primeri magisterijev iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28inclusion%20AND%20and%20AND%20diversity%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Literatura iz knjižnic (COBISS, šolska knjižnica)](https://plus.cobiss.net/cobiss/si/sl/bib/search?q=vključenost+in+raznolikost&db=cobib&mat=allmaterials&cof=0_105b-v&cof=0_105b-r&cof=0_105f-z&cof=0_105b-j&cof=0_105b-v1&cof=0_105b-r4&tyf=0_knj&tyf=0_cla&tyf=0_evir&tyf=0_ser&max=100)
...
[**Anna's Archive** (globalna knjižnica skoraj vseh člankov in knjig)](https://annas-archive.gl/search?q=inclusion+and+diversity)

[**Anna's Archive (alternativni link 1)** (.pk domena)](https://annas-archive.pk/search?q=inclusion+and+diversity)

[**Anna's Archive (alternativni link 2)** (.gd domena)](https://annas-archive.gd/search?q=inclusion+and+diversity)
...
site:oatd.org inclusion and diversity AND inclusivity and diversity
...
Za raziskovanje teme o VKLJUČENOSTI IN RAZNOLIKOSTI, lahko uporabite številne (brezplačne) in slovenskim študentom dostopne baze. Spodaj vas čaka seznam le-teh in pa njihove direktne povezave, ki že izpolnjujejo kriterij iskanja o temi "vključenost in raznolikost".

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021+ s PDF dostopom)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=inclusion+and+diversity&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (mreža raziskovalcev z brezplačnimi članki)](https://www.researchgate.net/search/publication?q=inclusion+and+diversity)

[Iskanje na **CORE** (nad 300 milijonov odprtodostopnih akademskih del)](https://core.ac.uk/search?q=inclusion+and+diversity)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – ena največjih akademskih iskalnikov)](https://www.base-search.net/Search/Results?lookfor=inclusion+and+diversity&type=all)
...
Pri raziskovanju vključenosti in raznolikosti uporabi kombinacijo pristopov. Izvedi anonimne spletne vprašalnike med zaposlenimi za merjenje stopnje vključenosti. Uporabi strukturirane intervjuje z vodji in kadrovsko službo za poglobljeno razumevanje strategij upravljanja raznolikosti. Dodaj tudi analizo internih aktov in politik podjetja.

### Ali je za raziskavo vključenosti in raznolikosti primernejša kvalitativna ali kvantitativna metodologija?

Pri proučevanju vključenosti in raznolikosti je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo demografskih podatkov in strukture zaposlenih. Kvalitativni del naj obsega poglobljene intervjuje z zaposlenimi iz manjšinskih skupin, analizo organizacijske kulture in študije posameznih primerov dobrih praks.

### Kako opredeliti omejitve raziskave pri proučevanju vključenosti in raznolikosti?

V dispoziciji jasno zapiši omejitve pri zbiranju občutljivih osebnih podatkov. Navedi omejitve vzorca zaradi varstva osebnih podatkov (GDPR). Opredeli časovni okvir raziskave, na primer tri mesece. Zapiši tudi možne omejitve zaradi družbeno zaželenih odgovorov anketirancev pri vprašanjih o diskriminaciji in počutju na delovnem mestu.

### Kako pravilno zastaviti hipoteze o vključenosti in raznolikosti?

Hipoteze morajo biti konkretne in merljive. Primer: "Uvedba programa za upravljanje raznolikosti bo povečala inovativnost timov za 25%". Ali: "Izobraževanja o nezavednih pristranskostih bodo izboljšala organizacijsko klimo za 30%". Možna je tudi: "Višja stopnja vključenosti bo zmanjšala fluktuacijo zaposlenih za 20%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tej temi zelo priporočljiva. Vključi vsaj 8 do 12 najnovejših mednarodnih raziskav o vključenosti in raznolikosti na delovnem mestu. Dodaj primere dobrih praks iz multinacionalnih podjetij ali skandinavskih držav. Posebej pomembne so raziskave o učinkih raznolikosti na poslovno uspešnost organizacije.

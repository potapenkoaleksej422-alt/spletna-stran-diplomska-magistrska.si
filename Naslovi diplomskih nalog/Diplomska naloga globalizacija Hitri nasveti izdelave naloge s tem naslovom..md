---
Naslov objave: "Diplomska naloga globalizacija: Hitri nasveti izdelave naloge s tem naslovom."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-10T11:19:11+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga globalizacija: Hitri nasveti izdelave naloge s tem naslovom.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-globalizacija/](https://diplomska-magistrska.si/diplomska-naloga-globalizacija/)
...
Soočili ste se torej z izzivom, da morate začeti s pisanjem diplomskega dela o GLOBALIZACIJI.

Obstaja velika verjetnost, da vam bo ta prispevek tako koristen, da ga boste dodali med svoje zaznamke.

Kakorkoli že, moj cilj je, da iz te vsebine potegnete maksimalno korist in drastično skrajšate čas izdelave diplomske naloge o GLOBALIZACIJI.
...
- kako iskati že uspešne diplomske naloge, ki so prav tako raziskovale področje o "GLOBALIZACIJI"
- kako in kje najti diplomske naloge, ki se dotikajo podobne tematike
- kako skozi postopek iskanja literature na temo *"globalizacija"* poiskati knjige, priročnike, znanstvene članke in tuje vire

Ker podobno kot mnogi najbrž niste prepričani, kako se lotiti pisanja svojega dela, vam lahko svetujem, da je najprimerneje pričeti z raziskovanjem spletnih virov in pregledom že uspešnih nalog na temo globalizacija.
...
**globalizacija** je tema, s katero ste verjetno že seznanjeni in je morda del vašega vsakdana, naj bo to preko študija, osebnih zanimanj, prostočasnih dejavnosti ali osebnih izkušenj.
Če je tema ***"globalizacija"*** le začetna ideja in še niste določili natančnega naslova za svoje diplomsko delo, imam za vas dobro novico. Ob koncu te objave boste našli nasvete, ki vam bodo pomagali "brainstormati" ideje vašega (bodočega) zaključnega dela.

## Kako se lotiti pisanja dispozicije o "GLOBALIZACIJI"?

Vsaka diplomska naloga o "GLOBALIZACIJI" se začne z dispozicijo, ki služi kot natančno določen načrt vašega dela. Ta dokument mora obvezno vsebovati jasno definirane cilje in namen, izbrano raziskovalno metodologijo, predvideno kazalo vsebine, seznam literature za preučevanje ter jasno opredeljen raziskovalni problem z njegovimi omejitvami.
...
## Kateri tip raziskovalne metode izbrati za nalogo o GLOBALIZACIJI?

Pri raziskovanju teme o "GLOBALIZACIJI" se boste morali odločiti za ustrezen raziskovalni pristop. V slovenskem visokošolskem prostoru se naloge tipično delijo na teh pet osnovnih metodoloških vrst - seveda si vi izberite tistega, ki je za vaš naslov oz. tematiko najprimernejši in vam omogoča najhitrejšo pot do zaključka.
...
Ko prijavljate temo o "GLOBALIZACIJI", bodite izjemno previdni pri izbiri mentorja. Najbolj varna izbira je profesor, ki velja za "prizanesljivega" oziroma morda celo pasivnega ocenjevalca. Če ima vaš izbrani mentor zraven še svoje podjetje ali predava drugje na kakšnem drugem faksu, ste zadeli "terno" – zaradi pomanjkanja časa se namreč takšni mentorji redko spuščajo v malenkosti in ne komplicirajo. Še en pomemben nasvet: strogo se izogibajte dodajanju somentorjev. Več vključenih ljudi pomeni več različnih "muh" in zahtev, kar lahko izdelavo vaše diplomske naloge zavleče za več mesecev.

## Brskanje po tujih diplomskih nalogah

[Pregled sorodnih diplomskih del, ki so bila kadarkoli objavljena v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:globalizacija;1:20:211;)

[Tukaj boste našli primere hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=globalizacija&ct%5B%5D=thesis&yr_from=&yr_to=)

[Tukaj boste našli primere srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=globalizacija&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28globalization%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjižnično gradivo (COBISS in šolska knjižnica)](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=globalizacija&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=globalizacija&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=globalization&hl=en&as_sdt=0,5)

[**Anna's Archive** (obsežna zbirka skoraj vse akademske literature)](https://annas-archive.gl/search?q=globalization)

[**Anna's Archive (alternativna povezava 1)** (povezava .pk)](https://annas-archive.pk/search?q=globalization)

[**Anna's Archive (alternativna povezava 2)** (povezava .gd)](https://annas-archive.gd/search?q=globalization)
...
site:oatd.org globalization

site:oatd.org globalization AND internationalization
...
Pri iskanju literature za diplomsko o GLOBALIZACIJI lahko uporabite različne vire. Spodaj imate pripravljen seznam baz in pa direktnih povezav do le-teh, ki bodo samodejno sprožile iskanje po tovrstnih zbirkah na temo o "globalizacija".

### Znanstvene in akademske članke (Google Učenjak, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleški članki od 2021 naprej s prostim dostopom do PDF)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=globalization&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (globalna platforma za raziskovalce)](https://www.researchgate.net/search/publication?q=globalization)

[Iskanje na **CORE** (zbirka z več kot 300 milijoni odprtodostopnih člankov in člankov)](https://core.ac.uk/search?q=globalization)

[Iskanje na **BASE** (akademski iskalnik z več kot 400 milijoni dokumentov)](https://www.base-search.net/Search/Results?lookfor=globalization&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo globalizacije?

Pri proučevanju globalizacije lahko uporabiš kombinacijo pristopov. Izvedi poglobljene intervjuje z mednarodnimi strokovnjaki in ekonomisti. Analiziraj statistične podatke mednarodnih organizacij, kot sta WTO in Svetovna banka. Dodaj primerjalno analizo ekonomskih in kulturnih trendov v različnih državah.

### Ali je za raziskavo globalizacije primernejša kvalitativna ali kvantitativna metodologija?

Za raziskavo globalizacije je najprimernejša kombinirana metodologija. Kvantitativni del naj vključuje statistično analizo mednarodnih tokov kapitala, migracij in trgovinskih sporazumov. Kvalitativni del naj obsega analizo kulturnih vplivov, intervjuje s strokovnjaki in študije posameznih primerov.

### Kako opredeliti omejitve raziskave pri proučevanju globalizacije?

V dispoziciji jasno zapiši geografske in časovne omejitve raziskave. Navedi, da se boš osredotočil na določeno regijo ali gospodarski sektor. Opredeli omejitve pri dostopu do mednarodnih podatkov. Zapiši tudi metodološke omejitve pri zbiranju in interpretaciji mednarodnih statistik.

### Kako pravilno zastaviti hipoteze o globalizaciji?

Hipoteze morajo biti specifične in merljive. Primer: "Digitalna ekonomija bo povečala mednarodno trgovino za 40% v naslednjih petih letih". Ali: "Multinacionalna podjetja bodo spremenila 60% lokalnih poslovnih praks". Možna je tudi: "Globalizacija bo zmanjšala kulturne razlike za 35%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri globalizaciji ključnega pomena. Vključi vsaj 10 do 15 mednarodnih raziskav iz različnih akademskih institucij. Dodaj raziskave iz vodilnih ekonomskih inštitutov. Posebej pomembne so longitudinalne študije globalnih trendov.

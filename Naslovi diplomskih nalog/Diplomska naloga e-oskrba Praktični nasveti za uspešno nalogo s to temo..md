---
Naslov objave: "Diplomska naloga e-oskrba: Praktični nasveti za uspešno nalogo s to temo."
Datum objave: "2026-09-11"
Datum posodobitve objave: "2026-09-10T16:24:35+02:00"
Avtor objave: "diplomska magistrska"
Mesto objave: "https://diplomska-magistrska.si"
---

# Diplomska naloga e-oskrba: Praktični nasveti za uspešno nalogo s to temo.

> Celotno originalno objavo si lahko preberete na spletni strani [https://diplomska-magistrska.si/diplomska-naloga-e-oskrba/](https://diplomska-magistrska.si/diplomska-naloga-e-oskrba/)
...
Znašli ste se torej pred dejstvom, da se morate lotiti pisanja diplomske naloge o E-OSKRBI.

Morda ti bo ta objava celo v takšno pomoč, da si jo boš shranil/a med zaznamke.

V vsakem primeru si želim, da iz te objave izvlečeš največ kar se da, in si znižaš čas pripravljanja tvojega diplomskega dela o E-OSKRBI na absolutni minimum.
...
- kako poiskati uspešne diplomske naloge drugih študentov, ki so prav tako imeli temo o E-OSKRBI
- kje iskati diplomske naloge s podobno temo (in kako)
- kje in kako na temo o E-OSKRBI poiskati ustrezno literaturo – knjige, priročnike, znanstvene članke in tujo literaturo

Ker tako kot večina verjetno ne veste kje začeti s pisanjem svoje naloge, vam lahko povem, da je najbolje začeti tako, da na spletu prebrskate naloge, ki so na to temo (e-oskrba) že bile uspešne.
...
**e-oskrba** je zagotovo področje oziroma tema o kateri imate veliko predznanja in je morda na nek način že vpeta v vaše življenje, bodisi preko študentskega dela, lastnih interesov, hobijev ali družinskih razmer.
V kolikor je tema ***"e-oskrba"*** zgolj iztočnica ali misel in točnega naslova za diplomsko nalogo še NIMATE opredeljenega, potem vam prinašam odlične novice. Na koncu te objave sboste našli nekaj predlogov naslovov, ki vam bodo pomagali formirati vaš naslov bodoče diplomske naloge.

## Priprava dispozicije za diplomsko nalogo o E-OSKRBI

Dispozicija v slovenskem visokošolskem prostoru deluje kot strog in obvezen predpogoj, preden sploh začnete s pisanjem diplomske naloge o E-OSKRBI. V njej morajo biti striktno in jasno opredeljeni: cilji in namen raziskave, uporabljena metodologija, struktura oziroma kazalo vsebine, predviden seznam literature, morebitne omejitve ter obseg raziskovalnega problema.
...
Vse diplomske in magistrske naloge v Sloveniji v osnovi padejo v enega izmed naslednjih petih tipov raziskovalnih metod. Za vašo temo o E-OSKRBI boste morali izbrati tisto, ki je najprimernejša in vam hkrati omogoča diplomiranje z najmanj kompliciranja.
...
Izbira mentorja lahko dobesedno odloča o uspehu ali propadu vaše naloge o E-OSKRBI. Študentom močno svetujem, da izberejo mentorja, ki že med študijem (pri izpitih in kolokvijih) ni bil pretirano zahteven. Velik bonus je, če ima mentor poleg dela na vaši fakulteti še kakšen obšolski s.p., svoje podjetje ali pa predava še na kakšni drugi fakulteti. Takšni mentorji so običajno veliko bolj "pragmatični", življenjski in predvsem prezaposleni, da bi komplicirali pri nepomembnih podrobnostih. Obvezno pa se izognite "somentorstvu"! Dva mentorja (mentor in somentor) v praksi vedno pomenita dvojne težave pri usklajevanju njunih, pogosto nasprotujočih si mnenj.

## Iskanje podobnih diplomskih nalog

[Primeri vseh kadarkoli objavljenih diplomskih nalog v Sloveniji](http://openscience.si/NaprednoIskanje.aspx?q=1:14:e-oskrba;1:20:211;)

[Primeri hrvaških diplomskih nalog](https://zir.nsk.hr/search?type=advanced&conditions%5B0%5D%5Boperator%5D=AND&conditions%5B0%5D%5Bfield%5D=ti&conditions%5B0%5D%5Bcondition%5D=exact&conditions%5B0%5D%5Bvalue%5D=e-skrb&ct%5B%5D=thesis&yr_from=&yr_to=)

[Primeri srbskih diplomskih nalog](https://nardus.mpn.gov.rs/discover?scope=%2F&query=e-nega&submit=&locale-attribute=en)

[Primeri diplom iz celotnega sveta objavljenih v ali po letu 2020 in v angleščini (OATD repozitorij)](https://oatd.org/oatd/search?q=title%3A%28e-care%29%20AND%20language%3A%28en%20OR%20eng%20OR%20english%29%20AND%20pub_dt%3A%5B2020-01-01T00%3A00%3A00Z%20TO%20%2A%5D)

[Knjige (preveri COBISS ali šolsko knjižnico).](https://plus.cobiss.net/cobiss/si/sl/search/cobib?q=e-oskrba&tyf=knj_tskknj&tyf=knj_eknj&tyf=cla_tskcla&tyf=cla_ecla)

[Iskanje na Google Učenjak v slovenščini](https://scholar.google.si/scholar?hl=sl&as_sdt=0%2C5&q=e-oskrba&btnG=)

[Iskanje na Google Učenjak v angleščini](https://scholar.google.com/scholar?q=e-care&hl=en&as_sdt=0,5)

[**Anna's Archive** (zbirka skoraj vseh knjig in člankov tega sveta)](https://annas-archive.gl/search?q=e-care)

[**Anna's Archive (Mirror 1)** (alternativna povezava .pk)](https://annas-archive.pk/search?q=e-care)

[**Anna's Archive (Mirror 2)** (alternativna povezava .gd)](https://annas-archive.gd/search?q=e-care)
...
site:oatd.org e-care

site:oatd.org e-care AND telemedicine
...
Za kakovostno napisano diplomsko nalogo o E-OSKRBI imate za iskanje virov in literature več možnosti. Spodaj vas čaka nekaj primerov baz iskanja in pa direktnih povezav do njihovih iskalnikov na temo o "e-oskrba".

### Članke - akademske in znanstvene (Google Scholar, Anna's Archive)

[Iskanje na **Semantic Scholar** (angleščina, članki od 2021 naprej s PDF-ji)](https://www.semanticscholar.org/search?year%5B0%5D=2021&year%5B1%5D=2026&q=e-care&sort=relevance&pdf=true)

[Iskanje na **ResearchGate** (največje omrežje raziskovalcev na svetu)](https://www.researchgate.net/search/publication?q=e-care)

[Iskanje na **CORE** (največja zbirka odprtodostopnih raziskav – 300M+ dokumentov)](https://core.ac.uk/search?q=e-care)

[Iskanje na **BASE** (Bielefeld Academic Search Engine – 400M+ akademskih dokumentov)](https://www.base-search.net/Search/Results?lookfor=e-care&type=all)
...
### Katere raziskovalne metode so najprimernejše za analizo e-oskrbe?

Pri raziskovanju e-oskrbe uporabi kombinacijo različnih pristopov. Izvedi strukturirane ankete med uporabniki sistema za oceno uporabniške izkušnje. Uporabi polstrukturirane intervjuje z zdravstvenim osebjem in strokovnimi delavci na področju e-oskrbe. Za tehnični ali ekonomski del lahko dodaš še analizo stroškovne učinkovitosti in pregled zdravstvene statistike, če imaš ustrezna dovoljenja.

### Ali je za raziskavo e-oskrbe primernejša kvalitativna ali kvantitativna metodologija?

Pri preučevanju e-oskrbe je najprimernejša kombinirana metodologija. Kvantitativni del naj obsega statistično merjenje zadovoljstva pacientov, pogostosti uporabe in analizo števila opravljenih obravnav na daljavo. Kvalitativni del naj vključuje poglobljene intervjuje z medicinskimi sestrami ter analizo konkretnih študij primerov implementacije v prakso.

### Kako opredeliti omejitve raziskave pri proučevanju e-oskrbe?

V dispoziciji jasno zapiši omejitve glede dostopa do zdravstvenih podatkov zaradi strogih pravil varstva osebnih podatkov (GDPR). Navedi demografske in tehnične omejitve preučevane populacije, saj starejši pogosto specifično dojemajo in uporabljajo tehnologijo. Zapiši časovni okvir raziskave in opredeli, da se omejuješ posamezno platformo ali na določen zdravstveni zavod.

### Kako pravilno zastaviti hipoteze o e-oskrbi?

Pri hipotezah moraš biti konkreten in poskrbeti, da so merljive. Primer: "Uvedba storitev e-oskrbe bo zmanjšala število nujnih hospitalizacij kroničnih bolnikov za 20%". Ali: "Sistematično izobraževanje starejših o e-oskrbi bo povečalo redno uporabo rešitev za 35%". Možna je tudi: "Telemedicinska preventivna obravnava bo skrajšala obremenjenost osebja za 30%".

### Ali lahko uporabim primerjavo s tujimi raziskavami?

Primerjava s tujimi raziskavami je pri tehnološko-zdravstvenih temah ključnega pomena. Vključi vsaj 8 do 12 novejših raziskav iz EU okolja in ZDA. Dodaj predvsem primere dobrih praks iz skandinavskih držav, ki imajo zelo napredne in uveljavljene sisteme opolnomočenja pacientov na daljavo. Posebej relevantne so primerjalne študije o sprejemanju tehnologije med pacienti.
